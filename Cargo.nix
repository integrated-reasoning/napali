...
let
  nixifiedLockHash = "9fe22974f61185c3256468eca69e498da7877dbabe794acc7479a0c73a063e87";
...
in
{
  ...
  workspace = {
    napali = rustPackages.unknown.napali."0.1.0";
  };
  ...
  "unknown".napali."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "napali";
    version = "0.1.0";
    registry = "unknown";
